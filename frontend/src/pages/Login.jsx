    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-md w-full space-y-8 p-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Sign in to ESG Platform</h2>
          <p className="mt-2 text-gray-600 dark:text-gray-300">Manage your sustainability data</p>
        </div>
        ...
        <div className="text-center">
          ...
          <div className="mt-2 text-xs text-gray-500 dark:text-gray-500 space-y-1">
            ...
            <p>Supplier: supplier@test.com / 123456</p>
          </div>
        </div>
      </div>
    </div>
